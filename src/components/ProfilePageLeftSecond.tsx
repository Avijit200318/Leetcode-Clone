...
export default function ProfilePageLeftSecond() {
    return (
        <div className="customBackground w-[20%] h-full  rounded-lg px-3 py-4">
            <div className="flex items-center gap-4 w-full">
                <img src="" alt="" className='w-22 h-22 rounded-full bg-blue-500' />
                <div className="">
                    <h1 className="font-semibold text-lg">Avijit2003</h1>
                    <h2 className="text-sm">Avijit2003</h2>
                    <h2 className='mt-4 font-semibold'>Rank 164,334</h2>
                </div>
            </div>
            <div className="my-4 w-full max-h-48">
                <p className='line-clamp-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos est ducimus impedit magni atque. Quis nostrum deleniti, placeat, magni fugit delectus atque perferendis quod dicta ipsum voluptatum iure repellat hic nihil! Repudiandae quo asperiores a commodi odit consequatur consequuntur aut nam iusto vitae nihil rerum sequi dolores, praesentium corrupti quae inventore impedit recusandae consectetur sed, cupiditate officia, similique culpa ut. Labore, dignissimos nisi tempora totam aliquam incidunt laboriosam consectetur odit ipsum nam neque omnis? Iste unde omnis ducimus dolores rem.</p>
            </div>
            ...
            <div className="my-8 flex flex-col gap-4 text-gray-400">
                <div className="w-full flex gap-3 items-center">
                    ...
                    <h3 className="truncate w-[calc(100%-1.5rem)]">India</h3>
                </div>
                <div className="w-full flex gap-3 items-center">
                    <GraduationCap className='resize-custom w-6' />
                    <h3 className="truncate w-[calc(100%-1.5rem)]">Jadavpur University</h3>
                </div>
                <div className="w-full flex gap-3 items-center">
                    ...
                    <h3 className="truncate w-[calc(100%-1.5rem)]">github:Avijit2003.com</h3>
                </div>
                <div className="w-full flex gap-3 items-center">
                    ...
                    <h3 className="truncate w-[calc(100%-1.5rem)]">linkdin/avijti-130.com</h3>
                </div>
