"use client";
import CustomContributorGraph from '@/components/CustomContributorGraph';
import ProblemPageBarChart from '@/components/ProblemPageBarChart'
import ProfilePageLeftSecond from '@/components/ProfilePageLeftSecond'
import ProfilePageLInearChart from '@/components/ProfilePageLInearChart'
        ...
        <div className="flex gap-4 w-full h-56">
          <div className="customBackground border w-1/2 h-full rounded-md">
            <div className="w-full h-full flex gap-3 p-2">
              <div className="w-[75%] h-full bg-[var(--popover)] rounded-md overflow-hidden border">
